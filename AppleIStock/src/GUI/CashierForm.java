...
public class CashierForm extends javax.swing.JFrame {
    ...
    public CashierForm() {
        ...
        cashier = new Cashier(1, "CashierName", "Password");
        ...
        btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Cashier cashier = new Cashier(1, "CashierName", "Password");
        ...
        btnDone.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                lblBill.setText("Total Bill: $" + totalBill);
                lblQty.setText("Total Quantity: " + totalQuantity);
                System.out.println(totalBill + " and " + totalQuantity);
        ...
        btnRemoveList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedIndex != -1) {
                    ...
                    double priceRemoved = extractPriceFromProductInfo(removedItem);
            ...
            public void actionPerformed(ActionEvent e) {
                if (invoiceListModel.isEmpty()) {
                    ...
                    if (sellProducts()) {
                        ...
                        // You can update the product table here
                        loadProductData();
    ...
    private void loadProductData() {
        Cashier cashier = new Cashier(1, "CashierName", "Password"); // Create a Cashier instance
    ...
    private boolean sellProducts() {
        try {
            for (int i = 0; i < invoiceListModel.size(); i++) {
                ...
                double totalPrice = Double.parseDouble(productData[3].trim().split(":")[1].trim().replace("$", ""));
                int productId = selectedProduct.getProductId();

                if (!cashier.sellProduct(productId, 1, quantity, totalPrice)) {
                    return false;
                }
            }
            return true;
