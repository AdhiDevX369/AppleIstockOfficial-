...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        User authenticateUser = User.authenticateUser(username, password);

        if(authenticateUser != null){
            String position = authenticateUser.getPosition();
            ...
            JOptionPane.showMessageDialog(this, "Authentication failed. Please check your username and password.", "Error", JOptionPane.ERROR_MESSAGE);
        }
