...
public class ManagerForm extends javax.swing.JFrame {
    ...
    public ManagerForm() {
        initComponents();
        manager = new Manager(1, "ManagerName", "Password");
    ...
    private void loadProductData() {
        Manager manager = new Manager(1, "ManagerName", "Password"); // Create a Manager instance
    ...
    private String generateUniqueProductID(String name, String category) {
        // Generate a unique identifier (e.g., timestamp or random number)
        long timestamp = System.currentTimeMillis();

        // Concatenate name, category, and the unique identifier
        return name + "_" + category + "_" + timestamp;
    }
